...
const Dashboard = () => {
  ...
  const fetchServiceRequests = async () => {
    try {
      ...
      const response = await api.get('/counselor/service-requests');
  ...
  const handleSubmitRequest = async () => {
    ...
    try {
      ...
      await api.post('/counselor/service-requests', submissionData);

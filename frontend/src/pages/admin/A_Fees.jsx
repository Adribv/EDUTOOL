...
const A_Fees = () => {
  ...
  const fetchFees = async () => {
    try {
      const [feesResponse, approvalsResponse] = await Promise.all([
        axios.get('https://edulives.com/api/api/admin-staff/fee-structure/public'),
        axios.get('https://edulives.com/api/api/admin-staff/approvals?requestType=Fee')
      ]);
  ...
  const handleSubmit = async () => {
    try {
      if (editingFee) {
        await axios.put(`https://edulives.com/api/api/admin-staff/fee-structure/public/${editingFee._id || editingFee.id}`, formData);
  ...
  const handleDelete = async (feeId) => {
    if (window.confirm('Are you sure you want to delete this fee?')) {
      try {
        await axios.delete(`https://edulives.com/api/api/admin-staff/fee-structure/public/${feeId}`);

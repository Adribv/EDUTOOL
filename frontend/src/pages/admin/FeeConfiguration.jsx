...
function FeeConfiguration() {
  ...
  const { data: feeStructures, isLoading: isLoadingStructures } = useQuery({
    ...
    queryFn: async () => {
      const response = await axios.get('https://api.edulives.com/admin-staff/fee-structure/public');
      return response.data;
    },
    onError: (error) => {
  ...
  const mutation = useMutation({
    mutationFn: async (values) => {
      if (selectedFee) {
        return axios.put(`https://api.edulives.com/admin-staff/fee-structure/public/${selectedFee._id}`, values);
      } else {
        // Create approval request instead of directly creating fee
        return axios.post('https://api.edulives.com/admin-staff/fee-structure/approval', values);
      }
    },
    onSuccess: () => {
  ...
  const deleteMutation = useMutation({
    mutationFn: (id) => axios.delete(`https://api.edulives.com/admin-staff/fee-structure/public/${id}`),
    onSuccess: () => {
      queryClient.invalidateQueries(['feeStructures']);

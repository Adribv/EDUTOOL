...
function StudentRecords() {
  ...
  const { data: students = [], isLoading: studentsLoading } = useQuery({
    queryKey: ['students'],
    queryFn: async () => {
      const response = await axios.get('https://api.edulives.com/admin-staff/students/public');
  ...
  const mutation = useMutation({
    mutationFn: async (values) => {
      if (selectedStudent) {
        await axios.put(`https://api.edulives.com/admin-staff/students/public/${selectedStudent._id}`, values);
      } else {
        await axios.post('https://api.edulives.com/admin-staff/students/public', values);
      }
    },
    onSuccess: (data) => {
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id) => {
      await axios.delete(`https://api.edulives.com/admin-staff/students/public/${id}`);
    },
    onSuccess: () => {
      queryClient.invalidateQueries(['students']);
  ...
  const handleDownloadReport = async () => {
    try {
      ...
      const response = await axios.get(`https://api.edulives.com/admin-staff/students/export?${params.toString()}`, {
        responseType: 'blob'
      });
  ...
  const bulkImportMutation = useMutation({
    mutationFn: async (students) => {
      const response = await axios.post('https://api.edulives.com/admin-staff/students/bulk', { students });
      return response.data;
    },
    onSuccess: (data) => {
      queryClient.invalidateQueries(['students']);

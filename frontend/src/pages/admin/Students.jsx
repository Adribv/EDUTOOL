...
function Students() {
  ...
  const { data: students, isLoading: studentsLoading } = useQuery({
    queryKey: ['students'],
    queryFn: async () => {
      const response = await axios.get('https://api.edulives.com/admin-staff/students');
  ...
  const { data: classes, isLoading: classesLoading } = useQuery({
    queryKey: ['classes'],
    queryFn: async () => {
      const response = await axios.get('https://api.edulives.com/admin-staff/classes');
      return response.data;
    }
  });
  ...
  const mutation = useMutation({
    mutationFn: async (values) => {
      if (selectedStudent) {
        await axios.put(`https://api.edulives.com/admin-staff/students/${selectedStudent.id}`, values);
      } else {
        await axios.post('https://api.edulives.com/admin-staff/students', values);
      }
    },
    onSuccess: () => {
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id) => {
      await axios.delete(`https://api.edulives.com/admin-staff/students/${id}`);
    },
    onSuccess: () => {
      queryClient.invalidateQueries(['students']);
      setSnackbar({

...
function Students() {
  ...
  const { data: students, isLoading: studentsLoading } = useQuery({
    queryKey: ['students'],
    queryFn: async () => {
      const response = await axios.get('https://edulives.com/api/api/admin-staff/students');
  ...
  const { data: classes, isLoading: classesLoading } = useQuery({
    queryKey: ['classes'],
    queryFn: async () => {
      const response = await axios.get('https://edulives.com/api/api/admin-staff/classes');
      return response.data;
    }
  });
  ...
  const mutation = useMutation({
    mutationFn: async (values) => {
      if (selectedStudent) {
        await axios.put(`https://edulives.com/api/api/admin-staff/students/${selectedStudent.id}`, values);
      } else {
        await axios.post('https://edulives.com/api/api/admin-staff/students', values);
      }
    },
    onSuccess: () => {
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id) => {
      await axios.delete(`https://edulives.com/api/api/admin-staff/students/${id}`);
    },
    onSuccess: () => {
      queryClient.invalidateQueries(['students']);
      setSnackbar({

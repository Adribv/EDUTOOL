...
function PasswordLookup() {
  ...
  const requestLookupMutation = useMutation({
    mutationFn: async (data) => {
      const response = await axios.post('https://api.edulives.com/students/password-lookup/request', data);
  ...
  const verifyTokenMutation = useMutation({
    mutationFn: async (token) => {
      const response = await axios.get(`https://api.edulives.com/students/password-lookup/verify/${token}`);
      return response.data;
    },
    onSuccess: (data) => {
  ...
  const resetPasswordMutation = useMutation({
    mutationFn: async (data) => {
      const response = await axios.post('https://api.edulives.com/students/password-lookup/reset', data);
      return response.data;
    },
    onSuccess: () => {
